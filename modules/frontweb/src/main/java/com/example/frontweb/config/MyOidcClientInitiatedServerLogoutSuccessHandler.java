...
@Slf4j
public class MyOidcClientInitiatedServerLogoutSuccessHandler implements ServerLogoutSuccessHandler {
	 ...
	 */
	public MyOidcClientInitiatedServerLogoutSuccessHandler(
	...
	private URI endpointUri(URI endSessionEndpoint, String idToken, URI postLogoutRedirectUri) {
		...
		log.info("★★endpointUri = {}", builder.encode(StandardCharsets.UTF_8).build().toUri());
